...
/* stock FreeRTOS prototype; r0=entry, r2=stack words, priority on the stack */
extern void *xTaskCreateStatic(void *pxTaskCode, const char *pcName, unsigned int ulStackDepth, void *pvParameters, unsigned int uxPriority, void *puxStackBuffer, void *pxTaskBuffer);
/* 0xffffffff ticks = block forever */
extern int xQueueSemaphoreTake(void *xQueue, unsigned int xTicksToWait);
...
/* main's wait; the bit dispatcher is 0x4ec0c */
extern int xTaskNotifyWait(unsigned int ulBitsToClearOnEntry, unsigned int ulBitsToClearOnExit, unsigned int *pulNotificationValue, unsigned int xTicksToWait);
